 ...
 public UsersManager(){
  ...
  public static User Login(String id, String password){
   ...
   static void LoginView() {
      ...
      System.out.println("Enter Classes.User ID:");
      String ID = input.next();

      System.out.println("Enter Classes.User password:");
   ...
   private static void viewReaderPage() {
      int choice;
        do {
            System.out.println("**********    Welcome to the Classes.Reader Profile    *************");
   ...
   private static void  viewAdminPage() {
      int choice;
      do {
          System.out.println("******************** Welcome to the Classes.Admin Page ********************");
          System.out.println("                     Select From The Following Options: ");
          System.out.println("**********************************************************************");
          System.out.println(currentUser.toString());
          System.out.println( "----------------------------------------------------------------------------------------------------------");
          System.out.println("Press 1 to Add a book.");
          System.out.println("Press 2 to Display all Classes.Books");
   ...
   static void deleteUser() {
    ...
    if (deleteUser(name)) {
        System.out.println("The Classes.User is succesfully deleted");
    } else {
        System.err.println("You entered a wrong Classes.User name");
    }
}
   ...
   //    for (String key  : set) {
   //       Classes.User vl = allUsers.get(key);
